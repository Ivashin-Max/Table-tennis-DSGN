  ...
  return (
    ...
    >
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые Администрация сайта
        reg.llnino.ru (далее — Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта https://reg.llntnino.ru.
      </p>
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://reg.llntnino.ru.
      </p>
      <p>
      ...
      <p>
        2.10. Пользователь — любой посетитель веб-сайта https://reg.llntnino.ru.
      </p>
      <p>
      ...
      <p>
        3.1. Оператор имеет право: <br></br>— получать от субъекта персональных
        данных достоверные информацию и/или документы, содержащие персональные
        данные;
        <br></br> — в случае отзыва субъектом персональных данных согласия на
        ...
        персональных данных;
        <br></br> — самостоятельно определять состав и перечень мер, необходимых
      ...
      <p>
        3.2. Оператор обязан: <br></br>— предоставлять субъекту персональных
        данных по его просьбе информацию, касающуюся обработки его персональных
        данных; <br></br>— организовывать обработку персональных данных в
        порядке, установленном действующим законодательством РФ;
        <br></br>— отвечать на обращения и запросы субъектов персональных данных
        и их законных представителей в соответствии с требованиями Закона о
        персональных данных; <br></br>— сообщать в уполномоченный орган по
        ...
        запроса;
        <br></br>— публиковать или иным образом обеспечивать неограниченный
        доступ к настоящей Политике в отношении обработки персональных данных;{" "}
        <br></br> — принимать правовые, организационные и технические меры для
        ...
        действий в отношении персональных данных; <br></br>— прекратить передачу
      ...
      <p>
        4.1. Субъекты персональных данных имеют право: <br></br>— получать
        ...
        порядок ее получения установлен Законом о персональных данных; <br></br>
        ...
        предусмотренные законом меры по защите своих прав; <br></br>— выдвигать
        условие предварительного согласия при обработке персональных данных в
        целях продвижения на рынке товаров, работ и услуг; <br></br>— на отзыв
        ...
        обработке его персональных данных; <br></br>— на осуществление иных
        прав, предусмотренных законодательством РФ.
      </p>
      <p>4.2. Субъекты персональных данных обязаны:</p> — предоставлять
      Оператору достоверные данные о себе; <br></br>— сообщать Оператору об
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора ttligann@yandex.ru с
      ...
      <p>
        ...
        электронный адрес Оператора ttligann@yandex.ru с пометкой «Отзыв
      ...
      <p>
        ...
        Оператору с помощью электронной почты ttligann@yandex.ru.
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://reg.llntnino.ru/privacy-policy.
      </p>
    </Box>
  );
};
