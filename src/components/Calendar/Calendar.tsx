            ...
            <div className="calendar__table">
                {days.map((day, index) => (
                    <div className="calendar__column" key={day.dayName}>
                        ...
                        <div className="calendar__row">
                            <div className="calendar__headerCell">
                                {events.filter(event => (event.tourDateString === day.compareDate) && (event.date.getHours() <= 17 && event.date.getHours() > 12))
                                    .sort((a, b) => a.date.getTime() - b.date.getTime())
                                    .map((neededEvent, index) => (
                                        EventsRow(neededEvent, index)
                                    ))}
                        ...
                        <div className="calendar__row">
                            <div className="calendar__headerCell">
                                {events.filter(event => (event.tourDateString === day.compareDate) && (event.date.getHours() > 17))
                                    .sort((a, b) => a.date.getTime() - b.date.getTime())
